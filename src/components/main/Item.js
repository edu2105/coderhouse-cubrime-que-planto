...
const Item = ({id, title, description, pictureUrl, pricing, caring, loading}) => {
        ...
        <div className="item">
            ...
            <div className="item-description-container">
                <div className="item-description">
                    ...
                    {
                        loading ? (<Skeleton variant="text" sx={{ bgcolor: 'grey.400', fontSize: "1rem", width: "5rem" }} animation="wave" />) : (<p>{description}</p>)
                    }                    
                </div>
            </div>
        </div>
